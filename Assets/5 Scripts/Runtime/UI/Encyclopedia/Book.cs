...
public class Book : MonoBehaviour {
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        SetPage(Left.transform, (currentPage < bookPages.Length) ? bookPages[currentPage] : null);
        Left.transform.SetAsFirstSibling();
        ...
        SetPage(Right.transform, (currentPage < bookPages.Length - 1) ? bookPages[currentPage + 1] : null);

        RightNext.enabled = (currentPage < bookPages.Length - 2);
        SetPage(RightNext.transform, (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : null);
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        SetPage(Right.transform, bookPages[currentPage - 1]);
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.transform.SetAsFirstSibling();
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.enabled = (currentPage >= 2);
        SetPage(Left.transform, (currentPage >= 2) ? bookPages[currentPage - 2] : null);

        LeftNext.enabled = (currentPage >= 3);
        SetPage(LeftNext.transform, (currentPage >= 3) ? bookPages[currentPage - 3] : null);
    ...
    void UpdateSprites()
    {
        ...
        SetPage(LeftNext.transform, (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage - 1] : null);
        SetPage(RightNext.transform, (currentPage >= 0 && currentPage < bookPages.Length) ? bookPages[currentPage] : null);
    }
